namespace Imgur.API.Tests.EndpointResponses
{
    public class ImageEndpointResponses
    {
        ...
        {
            public const string FavoriteImageResponseTrue = "{\"data\":{\"error\":\"f\",\"request\":\"/3/image/CgBdJN9/favorite\",\"method\":\"POST\"},\"success\":true,\"status\":200}";
            public const string FavoriteImageResponseFalse = "{\"data\":{\"error\":\"u\",\"request\":\"/3/image/CgBdJN9/favorite\",\"method\":\"POST\"},\"success\":true,\"status\":200}";
        }
    }
}
