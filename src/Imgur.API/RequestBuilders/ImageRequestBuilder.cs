...
namespace Imgur.API.RequestBuilders
{
    internal class ImageRequestBuilder : RequestBuilderBase
    {
        ...
        /// <exception cref="ArgumentNullException"></exception>
        internal HttpRequestMessage UploadImageBinaryRequest(string url, byte[] image, string album = null, string title = null, string description = null)
        {
            if (string.IsNullOrEmpty(url))
                throw new ArgumentNullException(nameof(url));
        ...
        /// <exception cref="ArgumentNullException"></exception>
        internal HttpRequestMessage UploadImageStreamRequest(string url, Stream image, string album = null, string title = null, string description = null)
        {
            if (string.IsNullOrEmpty(url))
                throw new ArgumentNullException(nameof(url));
        ...
        /// <exception cref="ArgumentNullException"></exception>
        internal HttpRequestMessage UploadImageUrlRequest(string url, string image, string album = null, string title = null, string description = null)
        {
            if (string.IsNullOrEmpty(url))
                throw new ArgumentNullException(nameof(url));
