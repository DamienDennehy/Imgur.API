namespace Imgur.API.Tests.FakeResponses
{
    public class AlbumEndpointResponses
    {
        public class Imgur
        {
            public const string AddAlbumImagesAsync =
                "{\"data\":true,\"success\":true,\"status\":200}";

            public const string CreateAlbumAsync =
            ...
            public const string GetAlbumImageAsync =
            ...
            public const string GetAlbumImagesAsync =
            ...
            public const string RemoveAlbumImagesAsync =
                "{\"data\":true,\"success\":true,\"status\":200}";

            public const string SetAlbumImagesAsync =
                "{\"data\":true,\"success\":true,\"status\":200}";

            public const string UpdateAlbumAsync =
                "{\"data\":true,\"success\":true,\"status\":200}";
        }
