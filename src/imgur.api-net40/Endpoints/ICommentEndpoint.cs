...
namespace Imgur.API.Endpoints
{
    ...
    public interface ICommentEndpoint : IEndpoint
    {
        ...
        /// <returns></returns>
        int CreateCommentAsync(string comment, string galleryItemId, string parentId = null);
        ...
        /// <returns></returns>
        int CreateReplyAsync(string comment, string galleryItemId, string parentId);
        ...
        /// <returns></returns>
        bool ReportCommentAsync(int commentId, ReportReason reason);
