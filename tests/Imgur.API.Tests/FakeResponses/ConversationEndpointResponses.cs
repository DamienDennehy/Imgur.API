namespace Imgur.API.Tests.FakeResponses
{
    ...
    {
        public const string BlockSenderResponse =
            "{\"data\":true,\"success\":true,\"status\":200}";

        public const string CreateConversationResponse =
            "{\"data\":true,\"success\":true,\"status\":200}";

        public const string DeleteConversationResponse =
            "{\"data\":true,\"success\":true,\"status\":200}";

        public const string GetConversationResponse =
        ...
        public const string GetConversationsResponse =
        ...
        public const string ReportSenderResponse =
            "{\"data\":true,\"success\":true,\"status\":200}";
    }
}