...
namespace Imgur.API.Endpoints
{
    ...
    public interface IGalleryEndpoint
    {
        ...
        /// <returns></returns>
        int CreateGalleryItemCommentAsync(string comment, string galleryItemId);
        ...
        /// <returns></returns>
        int CreateGalleryItemCommentReplyAsync(string comment, string galleryItemId, string parentId);
